...
/-- States res:sextic-spoke from the short record for Erdős problem #1041. Transported from
ErdosProblems.Erdos1041.PaperCompleteR20.sextic_spoke_counterexample_whole in the
