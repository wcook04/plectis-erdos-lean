...
/-- States long1049:res:chargeceilings from the long record for Erdős problem #1049. Transported
from ErdosProblems.Erdos1049.PaperR7.charge_ceilings in the substantive development, whose
...
/-- States long1049:res:forcing, res:forcing from the long record and the short record for Erdős
problem #1049. Transported from ErdosProblems.Erdos1049.PaperR7.forcing_term in the
...
/-- States long1049:res:powerbracket from the long record for Erdős problem #1049. Transported
from ErdosProblems.Erdos1049.PaperR7.power_bracket in the substantive development, whose
statement was refereed against the paper in the coverage ledger. -/
...
/-- States long1049:res:scalar from the long record for Erdős problem #1049. Transported from
ErdosProblems.Erdos1049.PaperR7.scalar_margin in the substantive development, whose
statement was refereed against the paper in the coverage ledger. -/
