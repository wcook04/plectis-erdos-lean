...
/-- States long251:res:true-tail, res:true-tail from the long record and the short record for
Erdős problem #251. Transported from
ErdosProblems.Erdos251.PaperCompleteR20.real_dyadic_orbit_eq_true_tail_iff in the
