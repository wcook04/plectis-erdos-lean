...
/-- States long251:res:explicit-remainder from the long record for Erdős problem #251.
Transported from ErdosProblems.Erdos251.PaperR7.explicit_remainder_certificate in the
