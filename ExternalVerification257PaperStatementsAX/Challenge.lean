...
ErdosProblems.Erdos257.PaperCompleteR21.paper_exact_row_double_or_recycle in the substantive
development, whose statement was refereed against the paper in the coverage ledger. -/
...
/-- States record:257bm-k-dich from the long record for Erdős problem #257. Transported from
ErdosProblems.Erdos257.PaperCompleteR21.paper_exact_row_example_six_and_eleven in the
...
ErdosProblems.Erdos257.PaperCompleteR21.paper_returning_endpoint_may_fail_to_grow in the
substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
