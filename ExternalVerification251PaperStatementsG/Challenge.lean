...
namespace Erdos249257.ExternalVerification251PaperStatementsG
...
/-- States long251:res:infinite, res:infinite, res:irr-equivalence from the long record and the
short record for Erdős problem #251. Transported from
ErdosProblems.Erdos251.PaperR7.infinite_prime_gap_identity in the substantive development,
...
/-- States long251:res:irr-equivalence, res:irr-equivalence from the long record and the short
record for Erdős problem #251. Transported from
ErdosProblems.Erdos251.PaperR7.irrationality_reformulation in the substantive development,
whose statement was refereed against the paper in the coverage ledger. -/
...
/-- States long251:res:polynomialcountermodel from the long record for Erdős problem #251.
Transported from ErdosProblems.Erdos251.PaperR7.polynomial_countermodel in the substantive
...
/-- States long251:res:gap-nonperiodic, res:gap-nonperiodic from the long record and the short
record for Erdős problem #251. Transported from
ErdosProblems.Erdos251.PaperR7.prime_gaps_not_eventually_periodic in the substantive
development, whose statement was refereed against the paper in the coverage ledger. -/
theorem prime_gaps_not_eventually_periodic {h : ℕ} (hh : 0 < h) :
    ¬ ∃ N₀, ∀ N, N₀ ≤ N → primeGap0 (N + h) = primeGap0 N := by
  sorry

/-- States long251:res:boundedperturbation from the long record for Erdős problem #251.
Transported from ErdosProblems.Erdos251.PaperR7.rational_bounded_perturbation in the
...
/-- States long251:res:smallpair from the long record for Erdős problem #251. Transported from
ErdosProblems.Erdos251.PaperR7.rational_small_pair_bundle in the substantive development,
whose statement was refereed against the paper in the coverage ledger. -/
...
/-- States long251:res:escape-irrational, res:escape-irrational from the long record and the
short record for Erdős problem #251. Transported from
ErdosProblems.Erdos251.PaperR7.rationality_classification in the substantive development,
whose statement was refereed against the paper in the coverage ledger. -/
...
/-- States long251:res:signedwindow from the long record for Erdős problem #251. Transported
from ErdosProblems.Erdos251.PaperR7.real_signed_two_window in the substantive development,
whose statement was refereed against the paper in the coverage ledger. -/
...
/-- States long251:res:smallpair-real from the long record for Erdős problem #251. Transported
from ErdosProblems.Erdos251.PaperR7.real_small_pair_prime_endpoint in the substantive
development, whose statement was refereed against the paper in the coverage ledger. -/
...
/-- States long251:res:telescope from the long record for Erdős problem #251. Transported from
ErdosProblems.Erdos251.carryPartialSum_eq in the substantive development, whose statement
...
/-- States long251:res:abel from the long record for Erdős problem #251. Transported from
ErdosProblems.Erdos251.dyadicPartialSumQ_eq_start_add_differences in the substantive
development, whose statement was refereed against the paper in the coverage ledger. -/
...
/-- States res:infinite from the short record for Erdős problem #251. Transported from
ErdosProblems.Erdos251.irrational_realPrimeGapTail_zero_iff in the substantive development,
whose statement was refereed against the paper in the coverage ledger. -/
...
/-- States res:infinite from the short record for Erdős problem #251. Transported from
ErdosProblems.Erdos251.irrational_tsum_primeDyadicTerm_iff_primeGap in the substantive
development, whose statement was refereed against the paper in the coverage ledger. -/
...
/-- States long251:res:parts from the long record for Erdős problem #251. Transported from
ErdosProblems.Erdos251.prime0_dyadic_summation_by_parts in the substantive development,
whose statement was refereed against the paper in the coverage ledger. -/
...
/-- States res:infinite from the short record for Erdős problem #251. Transported from
ErdosProblems.Erdos251.realPrimeGapTail_eq_tsum_shifted_gaps in the substantive development,
whose statement was refereed against the paper in the coverage ledger. -/
...
/-- States res:infinite from the short record for Erdős problem #251. Transported from
ErdosProblems.Erdos251.realPrimeGapTail_recurrence in the substantive development, whose
...
/-- States res:infinite from the short record for Erdős problem #251. Transported from
ErdosProblems.Erdos251.realPrimeGapTail_zero in the substantive development, whose statement
was refereed against the paper in the coverage ledger. -/
theorem realPrimeGapTail_zero :
    realPrimeGapTail 0 = 2 * (∑' n : ℕ, primeGapDyadicTerm n) - 1 := by
  sorry

/-- States long251:xr:totient from the long record for Erdős problem #251. Transported from
ErdosProblems.Erdos251.tailShift_integral_totient_of_odd_den in the substantive development,
whose statement was refereed against the paper in the coverage ledger. -/
...
end Erdos249257.ExternalVerification251PaperStatementsG
