...
/-!
# Deliberate Comparator mismatch for the Erdős #68 prime-pole formula

The theorem below adds an unused `True` hypothesis to the trusted statement.
It remains provable, but its declaration type must be rejected by Comparator.
-/
