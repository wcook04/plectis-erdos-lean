...
`Erdos249257.CyclotomicProjectionOfShadow`, `Erdos249257.RadicalMobiusShadow`,
`Erdos249257.RepunitMobiusNumerator`,
`ErdosProblems.Erdos249.PaperCompleteR20.NumeratorEvaluation`,
...
`ErdosProblems.Erdos249.PaperCompleteR21.NumeratorPolynomialAndMersenneRemainder`.
-/
...
namespace Erdos249257.ExternalVerification249PaperStatementsAQ
...
/-- States catalogue:mob:b5 from the long record for Erdős problem #249. Transported from
Erdos249257.CyclotomicProjectionOfShadow.cyclotomicValue_dvd_baseMobiusShadow_den in the
...
/-- States catalogue:mob:b5 from the long record for Erdős problem #249. Transported from
Erdos249257.CyclotomicProjectionOfShadow.mobiusNumerator_gcd_cyclotomicValue in the
substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
...
Erdos249257.CyclotomicProjectionOfShadow.mobiusNumerator_mod_cyclotomicEval in the
substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
...
/-- States catalogue:mob:b2, catalogue:mob:b5 from the long record for Erdős problem #249.
Transported from Erdos249257.RepunitMobiusNumerator.mobiusNumeratorPolynomial_eval_two in
...
/-- States catalogue:mob:b2 from the long record for Erdős problem #249. Transported from
ErdosProblems.Erdos249.PaperCompleteR20.numerator_eval_two_divisors in the substantive
...
/-- States catalogue:mob:b3 from the long record for Erdős problem #249. Transported from
ErdosProblems.Erdos249.PaperCompleteR20.radical_decomposition in the substantive
development, whose statement was refereed against the paper in the coverage ledger. -/
...
Transported from ErdosProblems.Erdos249.PaperCompleteR21.paperNumeratorPolynomial_eq in the
substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
...
/-- States the paper statement it is bound to from the long record for Erdős problem #249.
Transported from ErdosProblems.Erdos249.PaperCompleteR21.sum_divisorIndices_radical_form in
the substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
...
end Erdos249257.ExternalVerification249PaperStatementsAQ
