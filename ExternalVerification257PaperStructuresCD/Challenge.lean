...
namespace Erdos249257.ExternalVerification257PaperStructuresCD
...
Erdos249257.half_mem_mersenneAchievementSet_iff_unboundedUpperOrMiddle in the substantive
...
Erdos249257.half_mem_mersenneAchievementSet_of_largestSkipLateStepSocket in the substantive
development, whose statement was refereed against the paper in the coverage ledger. -/
...
/-- States thm:middle-producer-escape from the long record for Erdős problem #257. Transported
from Erdos249257.half_mem_mersenneAchievementSet_of_middleProducerCardEscape in the
...
/-- States thm:middle-producer-escape from the long record for Erdős problem #257. Transported
from Erdos249257.half_mem_mersenneAchievementSet_of_middleProducerRowEscape in the
substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
...
Erdos249257.half_mem_mersenneAchievementSet_of_upperResetDyadicBandEscape in the substantive
development, whose statement was refereed against the paper in the coverage ledger. -/
...
from Erdos249257.middleProducer_allRight_forces_rational_skip in the substantive
development, whose statement was refereed against the paper in the coverage ledger. -/
...
end Erdos249257.ExternalVerification257PaperStructuresCD
