...
/-- States long1049:res:archcap from the long record for Erdős problem #1049. Transported from
ErdosProblems.Erdos1049.PaperR9.long_record_archcap in the substantive development, whose
