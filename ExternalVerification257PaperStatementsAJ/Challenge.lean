...
/-- States thm:mobius-lambert-identity from the long record for Erdős problem #257. Transported
from MersenneLambertLadder.tsum_moebius_div_two_pow_sub_one_eq_half in the substantive
