...
`ErdosProblems.Erdos243.PaperCompleteR7.LcmDefect`.
-/

open Filter

namespace Erdos249257.ExternalVerification243PaperStatementsS
...
/-- States res:lcmbounded from the short record for Erdős problem #243. Transported from
ErdosProblems.Erdos243.PaperCompleteR7.original_coordinate_lcm_bounded_defect in the
...
end Erdos249257.ExternalVerification243PaperStatementsS
