...
namespace Erdos249257.ExternalVerification257PaperStatementsAG
...
/-- States res:period from the short record for Erdős problem #257. Transported from
Erdos249257.coprime_base_den_finiteErdosSum in the substantive development, whose statement
...
/-- States thm:multiples-support from the long record for Erdős problem #257. Transported from
Erdos249257.erdosSupportSeries_multiples_eq_pow_base_full_support in the substantive
...
/-- States thm:weighted-coeff-engine from the long record for Erdős problem #257. Transported
from Erdos249257.irrational_coeff_series_of_weighted_coeff_block_certificates in the
...
/-- States thm:factorial-twopow-support from the long record for Erdős problem #257. Transported
from Erdos249257.irrational_erdosSum_factorial_support in the substantive development, whose
...
/-- States thm:full-support, thm:full-support-catalogue from the long record for Erdős problem
#257. Transported from Erdos249257.irrational_erdosSum_full_support in the substantive
development, whose statement was refereed against the paper in the coverage ledger. -/
theorem irrational_erdosSum_full_support (b : ℕ) (hb : 2 ≤ b) :
    Irrational (∑' k : ℕ, (1 : ℝ) / ((b : ℝ) ^ (k + 1) - 1)) := by
  sorry

/-- States thm:lcm-gap-engine from the long record for Erdős problem #257. Transported from
Erdos249257.irrational_erdosSum_of_lcm_gap in the substantive development, whose statement
was refereed against the paper in the coverage ledger. -/
...
/-- States thm:factorial-twopow-support from the long record for Erdős problem #257. Transported
from Erdos249257.irrational_erdosSum_two_pow_support in the substantive development, whose
statement was refereed against the paper in the coverage ledger. -/
theorem irrational_erdosSum_two_pow_support (b : ℕ) (hb : 2 ≤ b) :
    Irrational (∑' k, (1 : ℝ) / ((b : ℝ) ^ (2 ^ k) - 1)) := by
  sorry

/-- States thm:eventually-periodic from the long record for Erdős problem #257. Transported from
Erdos249257.irrational_erdosSupportSeries_eventuallyPeriodic in the substantive development,
...
/-- States thm:multiples-support from the long record for Erdős problem #257. Transported from
Erdos249257.irrational_erdosSupportSeries_multiples in the substantive development, whose
statement was refereed against the paper in the coverage ledger. -/
theorem irrational_erdosSupportSeries_multiples (b d : ℕ) (hb : 2 ≤ b) (hd : 1 ≤ d) :
    Irrational (erdosSupportSeries b {n : ℕ | d ∣ n}) := by
  sorry

/-- States thm:residue-odd from the long record for Erdős problem #257. Transported from
Erdos249257.irrational_erdosSupportSeries_odd in the substantive development, whose
statement was refereed against the paper in the coverage ledger. -/
theorem irrational_erdosSupportSeries_odd (b : ℕ) (hb : 2 ≤ b) :
    Irrational (erdosSupportSeries b {n : ℕ | Odd n}) := by
  sorry

/-- States lem:tail-transfer from the long record for Erdős problem #257. Transported from
Erdos249257.irrational_erdosSupportSeries_of_tail in the substantive development, whose
statement was refereed against the paper in the coverage ledger. -/
...
/-- States thm:pairwise-coprime from the long record for Erdős problem #257. Transported from
Erdos249257.irrational_erdosSupportSeries_pairwise_coprime in the substantive development,
whose statement was refereed against the paper in the coverage ledger. -/
...
Erdos249257.irrational_erdosSupportSeries_periodic in the substantive development, whose
statement was refereed against the paper in the coverage ledger. -/
...
/-- States thm:residue-odd from the long record for Erdős problem #257. Transported from
Erdos249257.irrational_erdosSupportSeries_residueClass in the substantive development, whose
statement was refereed against the paper in the coverage ledger. -/
...
/-- States lem:tail-transfer from the long record for Erdős problem #257. Transported from
Erdos249257.irrational_erdosSupportSeries_tail_of_irrational in the substantive development,
whose statement was refereed against the paper in the coverage ledger. -/
...
/-- States thm:signed-periodic from the long record for Erdős problem #257. Transported from
Erdos249257.irrational_intWeightedErdosSeries_periodic_of_coeff_nonneg_of_frequently_ne_zero
...
/-- States thm:signed-periodic from the long record for Erdős problem #257. Transported from
Erdos249257.irrational_intWeightedErdosSeries_periodic_of_coeff_nonpos_of_frequently_ne_zero
in the substantive development, whose statement was refereed against the paper in the
coverage ledger. -/
...
/-- States thm:signed-periodic from the long record for Erdős problem #257. Transported from
Erdos249257.irrational_or_bpow_mul_eq_intCast_intWeightedErdosSeries_periodic in the
substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
...
/-- States res:period from the short record for Erdős problem #257. Transported from
Erdos249257.lcm_lt_den_finiteErdosSum in the substantive development, whose statement was
...
/-- States record:257bm-i-bridge from the long record for Erdős problem #257. Transported from
Erdos249257.supportCoeff_le_card_divisors in the substantive development, whose statement
was refereed against the paper in the coverage ledger. -/
...
/-- States record:257bm-i-bridge from the long record for Erdős problem #257. Transported from
Erdos249257.supportCoeff_le_self in the substantive development, whose statement was
refereed against the paper in the coverage ledger. -/
theorem supportCoeff_le_self (A : Set ℕ) (n : ℕ) : supportCoeff A n ≤ n := by
  sorry

end Erdos249257.ExternalVerification257PaperStatementsAG
