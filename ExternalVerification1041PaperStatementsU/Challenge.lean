...
Transported from ErdosProblems.Erdos1041.PaperCompleteR21.primitive_quintic_two_tail in the
...
/-- States thm:primitive-quintic-two-tail from the long record for Erdős problem #1041.
Transported from
ErdosProblems.Erdos1041.PaperCompleteR21.primitive_quintic_two_tail_of_polynomial in the
substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
...
/-- States res:primitive-quintic from the short record for Erdős problem #1041. Transported from
ErdosProblems.Erdos1041.PaperPrimitiveCompletionR10.complete_primitive_quintic in the
substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
