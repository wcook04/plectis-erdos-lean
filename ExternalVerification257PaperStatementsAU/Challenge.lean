...
namespace Erdos249257.ExternalVerification257PaperStatementsAU
...
/-- States lem:collapse-mech from the long record for Erdős problem #257. Transported from
Erdos249257.binaryCoeffTail_supportCoeff_le_two_sqrt_add_four in the substantive
...
Erdos249257.erdosSupportSeries_rational_iff_exists_temperedCarry in the substantive
development, whose statement was refereed against the paper in the coverage ledger. -/
...
/-- States record:257bm-i-bridge from the long record for Erdős problem #257. Transported from
Erdos249257.erdosSupportSeries_two_eq_binaryCoeffSeries in the substantive development,
...
/-- States record:257bm-i-mob from the long record for Erdős problem #257. Transported from
Erdos249257.mobius_supportCoeff_boolean in the substantive development, whose statement was
...
/-- States record:257bm-i-mob from the long record for Erdős problem #257. Transported from
Erdos249257.mobius_supportCoeff_eq_one_iff in the substantive development, whose statement
...
/-- States record:257bm-i-mob from the long record for Erdős problem #257. Transported from
Erdos249257.moebius_mul_supportCoeffAF in the substantive development, whose statement was
refereed against the paper in the coverage ledger. -/
theorem moebius_mul_supportCoeffAF (A : Set ℕ) :
    ArithmeticFunction.moebius * supportCoeffAF A = positiveSupportBitAF A := by
  sorry

end Erdos249257.ExternalVerification257PaperStatementsAU
