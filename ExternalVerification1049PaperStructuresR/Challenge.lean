...
/-- States res:archimedean-cap from the short record for Erdős problem #1049. Transported from
ErdosProblems.Erdos1049.PaperR9.short_note_archimedean_cap in the substantive development,
