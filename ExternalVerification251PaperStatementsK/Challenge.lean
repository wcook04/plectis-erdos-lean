...
/-- States long251:res:sparse-nonconcentration from the long record for Erdős problem #251.
Transported from ErdosProblems.Erdos251.PaperCompleteR20.sparse_nonconcentration in the
