...
namespace Erdos249257.ExternalVerification249PaperStatementsAI

/-- States catalogue:cert:d1, prop:D1D2-inv from the long record for Erdős problem #249.
Transported from Erdos249257.irrational_of_den_mul_abs_sub_tendsto_zero in the substantive
...
Transported from Erdos249257.irrational_of_int_mul_near_int in the substantive development,
...
/-- States catalogue:cert:d2, prop:D1D2-inv from the long record for Erdős problem #249.
Transported from Erdos249257.irrational_of_pow_mul_near_int in the substantive development,
whose statement was refereed against the paper in the coverage ledger. -/
...
Erdos249257.one_div_den_mul_den_le_abs_sub in the substantive development, whose statement
...
Erdos249257.totient_carry_residue_window_1_240_eq in the substantive development, whose
...
/-- States catalogue:mob:a1a from the long record for Erdős problem #249. Transported from
Erdos249257.totient_series_eq_half_add_moebius_mersenne_square in the substantive
development, whose statement was refereed against the paper in the coverage ledger. -/
...
/-- States prop:coprime from the long record for Erdős problem #249. Transported from
Erdos249257.totient_series_eq_half_add_visible_coprime_pairs in the substantive development,
whose statement was refereed against the paper in the coverage ledger. -/
...
/-- States thm:denommobsq from the long record for Erdős problem #249. Transported from
Erdos249257.tsum_moebius_div_two_pow_sub_one_sq_ne_int_div_of_den_le_39819823323350687661677887437915526
...
/-- States thm:denom from the long record for Erdős problem #249. Transported from
...
/-- States prop:coprime from the long record for Erdős problem #249. Transported from
Erdos249257.tsum_visible_coprime_pairs_eq_totient_series in the substantive development,
whose statement was refereed against the paper in the coverage ledger. -/
...
/-- States thm:denomcoprime from the long record for Erdős problem #249. Transported from
Erdos249257.tsum_visible_coprime_pairs_ne_int_div_of_den_le_39819823323350687661677887437915526
in the substantive development, whose statement was refereed against the paper in the
coverage ledger. -/
...
end Erdos249257.ExternalVerification249PaperStatementsAI
