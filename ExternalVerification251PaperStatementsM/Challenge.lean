...
/-- States long251:xr:propagate from the long record for Erdős problem #251. Transported from
ErdosProblems.Erdos251.PaperCompleteR20.realTailShift_integral_add in the substantive
...
/-- States eq:affinecofinal, eq:affinecollapse, eq:dyadicscale from the long record for Erdős
problem #251. Transported from ErdosProblems.Erdos251.PaperR7.affine_circularity_bundle in
...
/-- States long251:res:lcmdiagonal from the long record for Erdős problem #251. Transported from
ErdosProblems.Erdos251.irrational_initial_iff_all_lcmDiagonal_nonintegral in the substantive
development, whose statement was refereed against the paper in the coverage ledger. -/
