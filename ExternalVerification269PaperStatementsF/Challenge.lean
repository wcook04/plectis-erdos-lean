...
/-- States long269:res:exact-denominator from the long record for Erdős problem #269.
Transported from ErdosProblems.Erdos269.PaperR13.firstClearingIndex_le_sufficient in the
...
/-- States long269:res:exact-denominator from the long record for Erdős problem #269.
Transported from ErdosProblems.Erdos269.PaperR13.firstClearingIndex_minimal in the
substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
...
/-- States long269:res:exact-denominator from the long record for Erdős problem #269.
Transported from ErdosProblems.Erdos269.PaperR13.firstClearingIndex_spec in the substantive
...
ErdosProblems.Erdos269.PaperR13.scaled_state_is_integer_iff_firstClearingIndex_le in the
substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
...
/-- States long269:res:window-growth from the long record for Erdős problem #269. Transported
from ErdosProblems.Erdos269.PaperR7.long_window_growth in the substantive development, whose
