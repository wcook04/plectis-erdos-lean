...
/-!
# Erdős #257, record sections 6 to 9: detailed results and their hypotheses; which hypotheses remain unproved (part 1 of 4)
...
/-- States thm:two-sided-dyadic from the long record for Erdős problem #257. Transported from Erdos249257.SeamTwoSidedDyadicCellEscape.twoSided in the substantive development, whose statement was refereed against the paper in the coverage ledger. -/
theorem SeamTwoSidedDyadicCellEscape.twoSided
  ...
  sorry
/-- States thm:largest-skip-late from the long record for Erdős problem #257. Transported from Erdos249257.largestSkipLateAt_fourteen in the substantive development, whose statement was refereed against the paper in the coverage ledger. -/
...
theorem seamGreedy_terminal_false_iff_upperOrMiddle
  ...
  sorry
/-- States record:257bm-c12 from the long record for Erdős problem #257. Transported from Erdos249257.seamUpperBranch_remainder_add_resetCharge_eq in the substantive development, whose statement was refereed against the paper in the coverage ledger. -/
theorem seamUpperBranch_remainder_add_resetCharge_eq
    ...
    seamIntegerGreedyRemainder (d + 1) +
      ...
      2 ^ (d + 1) := by
  sorry
/-- States thm:seam-limit from the long record for Erdős problem #257. Transported from ErdosProblems.Erdos257.PaperCompleteR21.mem_seamGreedySupport_iff_scaled in the substantive development, whose statement was refereed against the paper in the coverage ledger. -/
theorem mem_seamGreedySupport_iff_scaled {s d : ℕ} (hs : 2 ≤ s) (h2 : 2 ≤ d)
  ...
  sorry
/-- States the paper statement it is bound to from the long record for Erdős problem #257. Transported from ErdosProblems.Erdos257.PaperCompleteR21.paperResetSqrtEscape_iff_square in the substantive development, whose statement was refereed against the paper in the coverage ledger. -/
