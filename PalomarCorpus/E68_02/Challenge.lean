...
/-!
# Erdős #68, record sections 3 to 5: rationality and the next integer above a scaled partial sum; a sufficient comparison between the tail and an integer gap; what can be achieved by cancelling finitely many weighted sums
