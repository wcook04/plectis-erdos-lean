...
/-!
# Erdős #249, record sections 12.3 to 12.5: the four-term decomposition; depth equal to a period multiple
...
/-- States prop:dickman from the long record for Erdős problem #249. Transported from ErdosProblems.Erdos249.PaperCompleteR21.prop_dickman in the substantive development, whose statement was refereed against the paper in the coverage ledger. -/
...
/-- States prop:route4 from the long record for Erdős problem #249. Transported from ErdosProblems.Erdos249.PaperCompleteR21.bracket_of_two_sided_separation in the substantive development, whose statement was refereed against the paper in the coverage ledger. -/
