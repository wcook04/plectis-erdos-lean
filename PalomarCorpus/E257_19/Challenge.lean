...
/-!
# Erdős #257, record sections 6.2 to 6.3: exact identities and reductions; consequence theorems (part 1 of 2)
...
theorem greedyHalfFrozenMargin_fullShell_eq_neg_seamRemainder_of_alignment
  ...
  sorry
/-- States lem:skipped-endpoint-trichotomy, record:257hg-i7 from the long record for Erdős problem #257. Transported from Erdos249257.halfGreedy_skipped_endpoint_trichotomy in the substantive development, whose statement was refereed against the paper in the coverage ledger. -/
