...
`Erdos249257.CarrySurvivorExtinction`, `Erdos249257.HalfUpperResetCriticalBand`,
...
/-- States prop:carry-survivor-extinction from the long record for Erdős problem #257.
Transported from ErdosProblems.Erdos257.PaperCompleteR21.paper_carry_survivor_extinction in
...
/-- States prop:carry-survivor-extinction from the long record for Erdős problem #257.
Transported from ErdosProblems.Erdos257.PaperCompleteR21.paper_periodLcm_is_prefix_lcm in
the substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
