...
/-- States res:sharp-fixed-base from the short record for Erdős problem #1049. Transported from
ErdosProblems.Erdos1049.PaperCompleteR21.SharpFixedBase.sharp_fixed_base_exists in the
