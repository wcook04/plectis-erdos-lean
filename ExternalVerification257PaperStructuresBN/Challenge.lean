...
`Erdos249257.HalfCylinderUpperResetBandCertificates`,
...
namespace Erdos249257.ExternalVerification257PaperStructuresBN
...
/-- States thm:upper-reset-band from the long record for Erdős problem #257. Transported from
Erdos249257.seamUpperResetDyadicBandEscape_through_thirty in the substantive development,
...
/-- States thm:cd-neg3-impossible from the long record for Erdős problem #257. Transported from
ErdosProblems.Erdos257.PaperCompleteR21.paper_final_middle_cell_at_least_neg_two in the
...
ErdosProblems.Erdos257.PaperCompleteR21.paper_final_middle_cell_ne_neg_three in the
substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
...
/-- States cor:cd-remaining from the long record for Erdős problem #257. Transported from
ErdosProblems.Erdos257.PaperCompleteR21.paper_final_middle_cell_remaining_cells in the
substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
...
ErdosProblems.Erdos257.PaperCompleteR21.paper_perturbed_nextRemainder_three_branches in the
substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
...
/-- States record:257bm-i15 from the long record for Erdős problem #257. Transported from
ErdosProblems.Erdos257.PaperCompleteR21.paper_perturbed_order_preservation in the
substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
...
/-- States record:257bm-i15 from the long record for Erdős problem #257. Transported from
ErdosProblems.Erdos257.PaperCompleteR21.paper_perturbed_prefixChoice_maximal in the
substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
...
end Erdos249257.ExternalVerification257PaperStructuresBN
