...
/-- States prop:sharp-collinear-chebyshev-comparator from the long record for Erdős problem
#1041. Transported from
ErdosProblems.Erdos1041.SharpCollinearChebyshev.exists_peak_le_comparisonBound in the
