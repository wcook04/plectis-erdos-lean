...
/-- States long251:res:complete-truncation from the long record for Erdős problem #251.
Transported from ErdosProblems.Erdos251.PaperCompleteR20.finite_separation_complete in the
...
/-- States long251:res:one-tail-certificate from the long record for Erdős problem #251.
Transported from ErdosProblems.Erdos251.PaperCompleteR20.one_tail_signed_certificate in the
substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
