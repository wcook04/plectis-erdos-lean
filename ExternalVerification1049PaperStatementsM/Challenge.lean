...
/-- States long1049:res:endpoints from the long record for Erdős problem #1049. Transported from
ErdosProblems.Erdos1049.PaperR7.endpoint_residues in the substantive development, whose
...
/-- States long1049:res:nomult from the long record for Erdős problem #1049. Transported from
ErdosProblems.Erdos1049.PaperR7.endpoint_scalar_content_exclusion in the substantive
...
/-- States long1049:res:jetkernel, res:jetkernel from the long record and the short record for
Erdős problem #1049. Transported from
ErdosProblems.Erdos1049.PaperR7.fourJet_paper_statement in the substantive development,
...
/-- States long1049:res:rankfortyone from the long record for Erdős problem #1049. Transported
from ErdosProblems.Erdos1049.PaperR7.rank_fortyone in the substantive development, whose
statement was refereed against the paper in the coverage ledger. -/
