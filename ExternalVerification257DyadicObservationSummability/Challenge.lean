...
/-!
# Trusted challenge for dyadic support-observation summability

After weighting each observation by the reciprocal of its conductor, the
dyadic incomplete-period masses are summable, their finite dyadic sums obey
an explicit majorant, and the sliding-window mean vanishes. No unweighted
summability of the atom costs is assumed. These estimates do not settle
Erdős #257.
-/
