...
theorem seamUpperResetCriticalBandEscape_iff :
    SeamUpperResetCriticalBandEscape ↔ SeamUpperResetDyadicBandEscape := @Erdos249257.HalfUpperResetCriticalBand.seamUpperResetCriticalBandEscape_iff
...
theorem paper_critical_band_index_collapse :
    (∀ d E : ℕ, DyadicBandEscape d E ↔
      ...
      (SeamUpperResetCriticalBandEscape ↔ SeamUpperResetDyadicBandEscape) := @ErdosProblems.Erdos257.PaperCompleteR21.paper_critical_band_index_collapse
