...
import Solutions.PalomarCorpus.E257aw.Statement
...
namespace PalomarCorpus.E257.PaperStatementsAW

theorem half_mem_mersenneAchievementSet_iff_no_lastHalfGreedySkip :
    (1 / 2 : ℝ) ∈ mersenneAchievementSet ↔
      ¬ ∃ M : ℕ, IsLastHalfGreedySkip M := @Erdos249257.half_mem_mersenneAchievementSet_iff_no_lastHalfGreedySkip

theorem isLastHalfGreedySkip_iff_skip_and_fatal
    {M : ℕ} :
    IsLastHalfGreedySkip M ↔
      M ∈ greedyMersenneSkippedSupport (1 / 2 : ℝ) ∧
        GreedyMersenneFatalAt (1 / 2 : ℝ) M := @Erdos249257.isLastHalfGreedySkip_iff_skip_and_fatal M

end PalomarCorpus.E257.PaperStatementsAW
