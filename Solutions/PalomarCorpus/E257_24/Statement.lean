...
/-!
# Statement environment for Palomar entry E257_24

Every non-theorem declaration of `PalomarCorpus/E257_24/Challenge.lean`, verbatim and in
...
namespace PalomarCorpus.E257.PaperStructuresCC
open Set
open scoped BigOperators
...
/-- States thm:final-middle-cell from the long record for Erdős problem #257. Transported from Erdos249257.finalMiddleCell_neg_three_not_last in the substantive development, whose statement was refereed against the paper in the coverage ledger. -/
theorem finalMiddleCell_neg_three_not_last
    ...
    False := by
  set_option smartUnfolding false in
  with_unfolding_all exact @Erdos249257.finalMiddleCell_neg_three_not_last D hD13 hncarry hmiddle hright hcell
end PalomarCorpus.E257.PaperStructuresCC
