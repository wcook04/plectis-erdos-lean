...
import Solutions.PalomarCorpus.E251q.Statement
...
theorem irrational_prime_series_of_finite_truncation (M : ℕ → ℝ)
    ...
    Irrational (∑' n : ℕ, primeDyadicTerm n) := @ErdosProblems.Erdos251.PaperR7.irrational_prime_series_of_finite_truncation M hM hsupply
