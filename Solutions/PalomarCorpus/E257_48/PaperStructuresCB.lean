...
import Solutions.PalomarCorpus.E257_48.Statement
...
set_option maxRecDepth 8000 in
/-- The local copy of `Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness` is the same function. -/
theorem HalfTerminalOnlyStripWitness_transport_def : @HalfTerminalOnlyStripWitness = @Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness := by
  first
  | (rfl; done)
  | (simp only [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def]; done)
  | (with_unfolding_all rfl; done)
  | (unfold HalfTerminalOnlyStripWitness Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness; done)
  | (unfold HalfTerminalOnlyStripWitness Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness <;> simp only [Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, *]; done)
  | (ext x; simp only [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def]; done)
  | (funext a; rfl; done)
  | (funext a; simp only [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def]; done)
  | (funext a; fun_induction HalfTerminalOnlyStripWitness a <;> simp only [Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, *]; done)
  | (funext a; induction a <;> simp only [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, *]; done)
  | (funext a; induction a <;> simp only [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, *]; done)
  | (funext a; induction a <;> simp [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, *]; done)
  | (funext a; simp [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def]; done)
  | (funext a b; rfl; done)
  | (funext a b; simp only [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def]; done)
  | (funext a b; fun_induction HalfTerminalOnlyStripWitness a b <;> simp only [Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, *]; done)
  | (funext a b; induction b <;> simp only [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, *]; done)
  | (funext a b; induction a generalizing b <;> simp only [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, *]; done)
  | (funext a b; induction a generalizing b <;> simp [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, *]; done)
  | (funext a b; induction b generalizing a <;> simp only [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, *]; done)
  | (funext a b; induction b generalizing a <;> simp [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, *]; done)
  | (funext a b; simp [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def]; done)
  | (funext a b c; rfl; done)
  | (funext a b c; simp only [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def]; done)
  | (funext a b c; fun_induction HalfTerminalOnlyStripWitness a b c <;> simp only [Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, *]; done)
  | (funext a b c; induction c <;> simp only [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, *]; done)
  | (funext a b c; induction a generalizing b c <;> simp only [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, *]; done)
  | (funext a b c; induction a generalizing b c <;> simp [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, *]; done)
  | (funext a b c; induction b generalizing a c <;> simp only [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, *]; done)
  | (funext a b c; induction b generalizing a c <;> simp [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, *]; done)
  | (funext a b c; induction c generalizing a b <;> simp only [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, *]; done)
  | (funext a b c; induction c generalizing a b <;> simp [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, *]; done)
  | (funext a b c; simp [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def]; done)
  | (simp [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def]; done)
  | (set_option smartUnfolding false in with_unfolding_all rfl; done)
  | (funext v1; simp only [HalfTerminalOnlyStripWitness, Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def] <;> rfl; done)
  | (funext v1; unfold HalfTerminalOnlyStripWitness Erdos249257.HalfCarryReachability.HalfTerminalOnlyStripWitness <;> simp only [supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def] <;> rfl; done)
...
theorem wordSuffixNumeral_transport_def : @wordSuffixNumeral = @Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral := by
  first
  | (rfl; done)
  | (simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def]; done)
  | (with_unfolding_all rfl; done)
  | (unfold wordSuffixNumeral Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral; done)
  | (unfold wordSuffixNumeral Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral <;> simp only [Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (ext x; simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def]; done)
  | (funext a; rfl; done)
  | (funext a; simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def]; done)
  | (funext a; fun_induction wordSuffixNumeral a <;> simp only [Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext a; induction a <;> simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext a; induction a <;> simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext a; induction a <;> simp [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext a; simp [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def]; done)
  | (funext a b; rfl; done)
  | (funext a b; simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def]; done)
  | (funext a b; fun_induction wordSuffixNumeral a b <;> simp only [Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext a b; induction b <;> simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext a b; induction a generalizing b <;> simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext a b; induction a generalizing b <;> simp [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext a b; induction b generalizing a <;> simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext a b; induction b generalizing a <;> simp [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext a b; simp [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def]; done)
  | (funext a b c; rfl; done)
  | (funext a b c; simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def]; done)
  | (funext a b c; fun_induction wordSuffixNumeral a b c <;> simp only [Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext a b c; induction c <;> simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext a b c; induction a generalizing b c <;> simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext a b c; induction a generalizing b c <;> simp [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext a b c; induction b generalizing a c <;> simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext a b c; induction b generalizing a c <;> simp [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext a b c; induction c generalizing a b <;> simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext a b c; induction c generalizing a b <;> simp [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext a b c; simp [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def]; done)
  | (simp [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def]; done)
  | (set_option smartUnfolding false in with_unfolding_all rfl; done)
  | (funext v1; simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def] <;> rfl; done)
  | (funext v1; unfold wordSuffixNumeral Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral <;> simp only [supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def] <;> rfl; done)
  | (funext v1 v2; simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def] <;> rfl; done)
  | (funext v1 v2; unfold wordSuffixNumeral Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral <;> simp only [supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def] <;> rfl; done)
  | (funext v1 v2 v3; simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def] <;> rfl; done)
  | (funext v1 v2 v3; unfold wordSuffixNumeral Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral <;> simp only [supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def] <;> rfl; done)
  | (funext v1 v2 v3 v4; simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def] <;> rfl; done)
  | (funext v1 v2 v3 v4; unfold wordSuffixNumeral Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral <;> simp only [supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def] <;> rfl; done)
  | (funext v1 v2 v3 v4; fun_induction wordSuffixNumeral v1 v2 v3 v4 <;> simp only [Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext v1 v2 v3 v4; induction v1 generalizing v2 v3 v4 <;> simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext v1 v2 v3 v4; induction v2 generalizing v1 v3 v4 <;> simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext v1 v2 v3 v4; induction v3 generalizing v1 v2 v4 <;> simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
  | (funext v1 v2 v3 v4; induction v4 generalizing v1 v2 v3 <;> simp only [wordSuffixNumeral, Erdos249257.SelectedSuffixCylinder.wordSuffixNumeral, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, *]; done)
...
@[simp] theorem HasSuffixCylinderAt_transport_def {M N R : ℕ} (W : SelectedHalfWindow N R) (hMN : M ≤ N) (endpoint : ℕ) :
  ...
  first
  | (rfl; done)
  | (simp only [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def]; done)
  | (with_unfolding_all rfl; done)
  | (unfold HasSuffixCylinderAt Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt; done)
  | (unfold HasSuffixCylinderAt Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt <;> simp only [Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, *]; done)
  | (ext x; simp only [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def]; done)
  | (funext a; rfl; done)
  | (funext a; simp only [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def]; done)
  | (funext a; fun_induction HasSuffixCylinderAt a <;> simp only [Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, *]; done)
  | (funext a; induction a <;> simp only [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, *]; done)
  | (funext a; induction a <;> simp only [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, *]; done)
  | (funext a; induction a <;> simp [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, *]; done)
  | (funext a; simp [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def]; done)
  | (funext a b; rfl; done)
  | (funext a b; simp only [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def]; done)
  | (funext a b; fun_induction HasSuffixCylinderAt a b <;> simp only [Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, *]; done)
  | (funext a b; induction b <;> simp only [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, *]; done)
  | (funext a b; induction a generalizing b <;> simp only [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, *]; done)
  | (funext a b; induction a generalizing b <;> simp [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, *]; done)
  | (funext a b; induction b generalizing a <;> simp only [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, *]; done)
  | (funext a b; induction b generalizing a <;> simp [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, *]; done)
  | (funext a b; simp [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def]; done)
  | (funext a b c; rfl; done)
  | (funext a b c; simp only [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def]; done)
  | (funext a b c; fun_induction HasSuffixCylinderAt a b c <;> simp only [Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, *]; done)
  | (funext a b c; induction c <;> simp only [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, *]; done)
  | (funext a b c; induction a generalizing b c <;> simp only [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, *]; done)
  | (funext a b c; induction a generalizing b c <;> simp [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, *]; done)
  | (funext a b c; induction b generalizing a c <;> simp only [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, *]; done)
  | (funext a b c; induction b generalizing a c <;> simp [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, *]; done)
  | (funext a b c; induction c generalizing a b <;> simp only [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, *]; done)
  | (funext a b c; induction c generalizing a b <;> simp [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, *]; done)
  | (funext a b c; simp [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def]; done)
  | (simp [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def]; done)
  | (set_option smartUnfolding false in with_unfolding_all rfl; done)
  ...
  | (simp only [HasSuffixCylinderAt, Erdos249257.SelectedSuffixCylinder.HasSuffixCylinderAt, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def] <;> rfl; done)
...
@[simp] theorem HasSuffixCylinderOnInterval_transport_def {M N L U : ℕ} (W : SelectedHalfInterval N L U) (hMN : M ≤ N) (endpoint : ℕ) :
  ...
  | (simp [HasSuffixCylinderOnInterval, Erdos249257.SuffixCylinderInStrip.HasSuffixCylinderOnInterval, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, HasSuffixCylinderAt_transport_def]; done)
  | (set_option smartUnfolding false in with_unfolding_all rfl; done)
  ...
  | (unfold HasSuffixCylinderOnInterval Erdos249257.SuffixCylinderInStrip.HasSuffixCylinderOnInterval <;> simp only [supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, HasSuffixCylinderAt_transport_def] <;> rfl; done)
  | (simp only [HasSuffixCylinderOnInterval, Erdos249257.SuffixCylinderInStrip.HasSuffixCylinderOnInterval, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, HasSuffixCylinderAt_transport_def] <;> rfl; done)
  | (unfold HasSuffixCylinderOnInterval Erdos249257.SuffixCylinderInStrip.HasSuffixCylinderOnInterval <;> simp only [supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, HasSuffixCylinderAt_transport_def] <;> set_option smartUnfolding false in with_unfolding_all rfl; done)
...
theorem exists_infinite_positive_support_half_of_cofinalCylinderStages
  ...
  simp only [← CylinderStage_transport_toSrc_endpoint, ← InStripTwoSheetStage_transport_toSrc_hole, ← InStripTwoSheetStage_transport_toSrc_seamCoeff, ← InStripTwoSheetStage_transport_toSrc_seamCut, ← InStripTwoSheetStage_transport_toSrc_upperEndpoint, ← HasSuffixCylinderAt_transport_def, ← HasSuffixCylinderOnInterval_transport_def, supportSuffixNumeral_transport_def, affineBinaryOrbit_transport_def, integerHalfCarry_transport_def, HalfStripAdmissible_transport_def, HalfTerminalOnlyStripWitness_transport_def, wordSuffixNumeral_transport_def, CylinderStage_transport_nonempty] at *
  exact @Erdos249257.SuffixCylinderTerminalOnlyBridge.exists_infinite_positive_support_half_of_cofinalCylinderStages hstages

theorem halfTerminalOnlyStripWitness_of_feedbackAdvance
    {K M : ℕ} (S : CylinderStage K M) :
    HalfTerminalOnlyStripWitness M := by
  set_option smartUnfolding false in
  with_unfolding_all exact @ErdosProblems.Erdos257.PaperCompleteR21.halfTerminalOnlyStripWitness_of_feedbackAdvance K M (CylinderStage_transport_toSrc S)

theorem halfTerminalOnlyStripWitness_of_inStripTwoSheetStage_via_carries_three_four
    {K M : ℕ} (T : InStripTwoSheetStage K M) :
    HalfTerminalOnlyStripWitness M := by
  set_option smartUnfolding false in
  with_unfolding_all exact @ErdosProblems.Erdos257.PaperCompleteR21.halfTerminalOnlyStripWitness_of_inStripTwoSheetStage_via_carries_three_four K M (InStripTwoSheetStage_transport_toSrc T)
...
theorem paper_shared_prefix_family_strip_witness_after_feedback_all_depths
  ...
  set_option smartUnfolding false in
  with_unfolding_all exact @ErdosProblems.Erdos257.PaperCompleteR21.paper_shared_prefix_family_strip_witness_after_feedback_all_depths K N (CylinderStage_transport_toSrc S) hK1N hrow
    ...
    ∃ a : HalfWord (N + 1),
      a ⟨0, Nat.zero_lt_succ (N + 1)⟩ = false ∧
        ...
        |(integerHalfCarry (wordSupport a) (N + 1 - 1) : ℝ)| ≤
          (halfStripBound (N + 1) : ℝ) := by
  set_option smartUnfolding false in
  with_unfolding_all exact @ErdosProblems.Erdos257.PaperCompleteR21.paper_shared_prefix_family_strip_witness_after_feedback_of_all_depths K N (CylinderStage_transport_toSrc S) _hN hK1N hrow _h27
