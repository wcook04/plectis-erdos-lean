...
theorem primitiveInterior_exists_two_tailEnergy_lt_one
    ...
    (s0 ^ 4 * (s0 + r ^ 2 + 2 * r * x0) < 1 ∧
      ...
      (s2 ^ 4 * (s2 + r ^ 2 + 2 * r * x2) < 1 ∧
        s4 ^ 4 * (s4 + r ^ 2 + 2 * r * x4) < 1) ∨
      (s3 ^ 4 * (s3 + r ^ 2 + 2 * r * x3) < 1 ∧
        s4 ^ 4 * (s4 + r ^ 2 + 2 * r * x4) < 1) := @ErdosProblems.Erdos1041.primitiveInterior_exists_two_tailEnergy_lt_one r x0 x1 x2 x3 x4 s0 s1 s2 s3 s4 hr hr2 hs0 hs0one hx0s hs1 hs1one hx1s hs2 hs2one hx2s hs3 hs3one hx3s hs4 hs4one hx4s hm1 hm2 hm3
