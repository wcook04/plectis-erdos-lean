...
/-- States res:separation-parent from the short record for Erdős problem #1041. Transported from
ErdosProblems.Erdos1041.PaperCompleteR21.SeparationParent.separation_parent in the
...
/-- States res:constant-factor-arity from the long record for Erdős problem #1041. Transported
from ErdosProblems.Erdos1041.PaperCompleteR21.cfa_arity_criterion in the substantive
...
/-- States res:constant-factor-path from the long record for Erdős problem #1041. Transported
from ErdosProblems.Erdos1041.PaperCompleteR21.cfa_constant_factor_path in the substantive
development, whose statement was refereed against the paper in the coverage ledger. -/
...
/-- States res:scaled-low-critical, res:scaled-low-critical-path from the long record and the
short record for Erdős problem #1041. Transported from
ErdosProblems.Erdos1041.PaperCompleteR21.scaledLowCriticalFiveHalves_of_lowCritical in the
substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
...
/-- States res:low-critical-scale-free, res:scaled-low-critical from the long record and the
short record for Erdős problem #1041. Transported from
ErdosProblems.Erdos1041.PaperCompleteR21.scaledLowCritical_of_lowCritical in the substantive
development, whose statement was refereed against the paper in the coverage ledger. -/
