...
ErdosProblems.Erdos1049.PaperCompleteR21.rational_base_threshold in the substantive
...
/-- States long1049:res:region, res:rational-base-threshold from the long record and the short
record for Erdős problem #1049. Transported from
ErdosProblems.Erdos1049.PaperCompleteR21.rational_base_threshold_log in the substantive
development, whose statement was refereed against the paper in the coverage ledger. -/
...
ErdosProblems.Erdos1049.PaperCompleteR21.thirtyoneFour_irrational in the substantive
development, whose statement was refereed against the paper in the coverage ledger. -/
theorem thirtyoneFour_irrational : Irrational (paperLambert ((31 : ℝ) / 4)) := by
  sorry

/-- States long1049:res:31over4 from the long record for Erdős problem #1049. Transported from
ErdosProblems.Erdos1049.PaperCompleteR21.thirtyoneFour_pow_irrational in the substantive
development, whose statement was refereed against the paper in the coverage ledger. -/
