...
ErdosProblems.Erdos249.PaperCompleteR21.no_generic_rationality_carryRank_ceiling in the
...
Transported from
ErdosProblems.Erdos249.PaperCompleteR21.rationalControl_periodic_with_unbounded_carry_rank
...
/-- States prop:CP-02 from the long record for Erdős problem #249. Transported from
ErdosProblems.Erdos249.PaperCompleteR21.rationality_forces_mod_period_and_unbounded_rank in
...
/-- States the paper statement it is bound to from the long record for Erdős problem #249.
Transported from
ErdosProblems.Erdos249.PaperCompleteR21.rationality_gives_mod_period_and_unbounded_rank in
the substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
