...
namespace Erdos249257.ExternalVerification257PaperStructuresBB
...
/-- States thm:two-sided-dyadic from the long record for Erdős problem #257. Transported from
Erdos249257.SeamTwoSidedDyadicCellEscape.twoSided in the substantive development, whose
...
/-- States thm:largest-skip-late from the long record for Erdős problem #257. Transported from
Erdos249257.largestSkipLateAt_fourteen in the substantive development, whose statement was
refereed against the paper in the coverage ledger. -/
theorem largestSkipLateAt_fourteen : LargestSkipLateAt 14 := by
  sorry

/-- States lem:seam-upper-or-middle, thm:largest-skip-late from the long record for Erdős
problem #257. Transported from Erdos249257.seamGreedy_terminal_false_iff_upperOrMiddle in
...
/-- States record:257bm-c12 from the long record for Erdős problem #257. Transported from
Erdos249257.seamUpperBranch_remainder_add_resetCharge_eq in the substantive development,
...
ErdosProblems.Erdos257.PaperCompleteR21.mem_seamGreedySupport_iff_scaled in the substantive
...
Transported from ErdosProblems.Erdos257.PaperCompleteR21.paperResetSqrtEscape_iff_square in
the substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
...
end Erdos249257.ExternalVerification257PaperStructuresBB
