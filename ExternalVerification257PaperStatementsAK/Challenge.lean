...
/-- States prop:canon, record:257bm-i11a from the long record for Erdős problem #257.
Transported from
Erdos249257.BooleanMobiusGreedyReduction.remainder_lt_gap_iff_eq_integerGreedyBits in the
substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
