...
/-- States res:constant-factor-capacity from the long record for Erdős problem #1041.
Transported from ErdosProblems.Erdos1041.PaperCompleteR21.cfa_capacity_criterion in the
