...
/-- States eq:critical-reflected-product, res:reflected-critical-value from the long record for
Erdős problem #1041. Transported from
ErdosProblems.Erdos1041.PaperReflectedCompletion.reflected_critical_value in the substantive
