...
Transported from Erdos249257.one_div_twenty_one_mem_iff_not_fatalAlignedBranch in the
...
/-- States res:one-over-twenty-one-frontier from the short record for Erdős problem #257.
Transported from Erdos249257.twentyOneFatalAlignedBranch_eventually_affine_supercapacity in
...
/-- States res:one-over-twenty-one-frontier from the short record for Erdős problem #257.
Transported from Erdos249257.twentyOneFatalAlignedBranch_eventually_strict_supercapacity in
the substantive development, whose statement was refereed against the paper in the coverage
ledger. -/
