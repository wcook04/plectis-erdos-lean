...
/-!
# Trusted challenge for variable-exponent fractional-cover irrationality

Every infinite subset of a strengthened positive-cover host is irrational at
every integer base at least two. The cover data retain variable exponents in
`(0,1]`, nonnegative coefficients, column summability, divisor majorisation,
and the one-inverse-power cost. This does not settle Erdős #257.
-/
